...
$id = $_GET['id'];
$cate_name = $_GET['cate'];
$query_post = "SELECT a.*,b.name as author_name FROM posts a left join authors b on a.author_id = b.id where a.status = 1 and a.id=".$id;
$result_post = $conn->query($query_post);
$post = $result_post->fetch_assoc();


// Load 5 bài viết cùng dang mục với bài viết đang đọc
$query_5posts = "SELECT * FROM posts where status = 1 and category_id = ".$post['category_id']." and id <> ".$id." limit 5";
			...
			<div id="post-header" class="page-header">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-10">
							<div class="post-meta">
								<a class="post-category cat-2" href="category.php"><?=$cate_name ?></a>
				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="section-row sticky-container">
							<div class="main-post">
								<h3><?= $post['title'] ?></h3>
								<p><b><i><?= $post['description'] ?></i></b></p>
								<p><?= $post['content'] ?></p>
								<p><b>Đăng bởi: <?= $post['author_name'] ?></b></p>
							</div>
					...
					<div class="col-md-4">
						...
						<div class="aside-widget">
							...
							<?php
							for ($i=0; $i < count($p_5posts); $i++) { 
 ?>

							<div class="post post-widget">
								<a class="post-img" href="blog-post.html"><img src="./img/widget-1.jpg" alt=""></a>
								<div class="post-body">
									<h3 class="post-title"><a href="blog-post.php"><?= $p_5posts[$i]['title'] ?></a></h3>
								</div>
							</div>
