...
$query_post = "SELECT a.*,b.name as author_name from posts a left join authors b on a.author_id = b.id";
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><img src="../img/<?= $post['thumbnail'] ?>" width = "60px" height = "40px"></td>
          <td>
            <a href="post_detail.php?id=<?= $post['id'] ?>" type="button" class="btn btn-default" width = "30px" >Xem</a>
